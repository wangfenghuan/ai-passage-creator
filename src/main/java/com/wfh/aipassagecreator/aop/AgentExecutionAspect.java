package com.wfh.aipassagecreator.aop;

import com.google.gson.Gson;
import com.wfh.aipassagecreator.annotation.AgentExecution;
import com.wfh.aipassagecreator.model.dto.article.ArticleState;
import com.wfh.aipassagecreator.model.entity.AgentLog;
...
/**
 * @Title: AgentExecutionAspect
 * @Author wangfenghuan
 * @Package com.wfh.aipassagecreator.aop
 * @Date 2026/3/17 08:36
 * @description:
 */
@Slf4j
@Aspect
...
public class AgentExecutionAspect {
    ...
    private String extractInputData(ProceedingJoinPoint pjp) {
        try {
            ...
            return inputMap.isEmpty() ? null : gson.toJson(inputMap);
        } catch (Exception e) {
            log.warn("提取输入数据失败", e);
            return null;
        }
