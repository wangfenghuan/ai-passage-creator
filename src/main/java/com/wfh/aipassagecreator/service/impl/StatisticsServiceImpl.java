    ...
    private Integer calculateAvgDuration() {
        ...
        try {
            ...
            double avgDuration = completedArticles.stream()
                    ...
                    .mapToLong(article -> {
                        long createMillis = java.sql.Timestamp.valueOf(String.valueOf(article.getCreateTime())).getTime();
                        long completedMillis = java.sql.Timestamp.valueOf(String.valueOf(article.getCompletedTime())).getTime();
