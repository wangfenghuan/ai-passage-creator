package com.wfh.aipassagecreator.agent.parallel;

import com.alibaba.cloud.ai.graph.OverAllState;
import com.alibaba.cloud.ai.graph.action.NodeAction;
import com.google.gson.Gson;
import com.wfh.aipassagecreator.agent.context.StreamHandlerContext;
    ...
    private List<ArticleState.ImageRequirement> convertToImageRequirements(List<?> list) {
        ...
        for (Object item : list) {
            if (item instanceof ArticleState.ImageRequirement) {
                ...
                ArticleState.ImageRequirement req = gson.fromJson(json, ArticleState.ImageRequirement.class);
                results.add(req);
            }
        }
        return results;
